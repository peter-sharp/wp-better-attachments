	...
	public function build_image_attachment_li( $attachments, $args = array() ) {
		...
		foreach ( $attachments as $attachment ) {
			...
			$html .= '<li class="wpba-attachment-item ui-state-default" id="attachment_'.$attachment_id.'" data-id="'.$attachment_id.'">' . $nl;
				...
				$html .= apply_filters('wpba_image_attachment_li_content_before', '', $attachment, $mime_type, $html ) . $nl;
				...
				$html .= apply_filters('wpba_image_attachment_li_content_after', '', $attachment, $mime_type, $html ) . $nl;
				$html .= '</div>' . $nl;
			$html .= '</li>'  . $nl;
		} // foreach();
